                    ...
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            <li>
                             ...
                             <li class="active">
                              <i class="glyphicon glyphicon-list-alt"></i> Create Coverage
                            </li>
                            <li class="active">
...
The Coverage is added Sucessfully!! <br>
The Coverage Name is <%=request.getAttribute("CoverageName") %>
<br>
The Coverage Status is <%=request.getAttribute("CoverageStatus") %>
<br>
The Covrage ID is <%=request.getAttribute("CoverageId") %> 
<br>
Please, Note the Coverage ID for Future Reference.

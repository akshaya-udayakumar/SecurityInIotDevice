...
The User is Created Sucessfully !<br>
The USER ID is <%=request.getAttribute("UserId") %>
<br>
The User Name is <%=request.getAttribute("UserName") %>
<br>
The User Role is <%=request.getAttribute("UserRole") %>
<br>
The User Status is <%=request.getAttribute("UserStatus") %>
</form>
</div>

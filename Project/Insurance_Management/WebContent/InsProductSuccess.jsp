                    ...
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            <li>
                             ...
                             <li class="active">
                               <i class="glyphicon glyphicon-equalizer"></i> Insurance Product
                            </li>
                            <li class="active">
...
The Insurance Product is Added Successfully!! 
<br>
The Insurance Product ID is <%=request.getAttribute("ProductId") %>
<br>
The Insuarnce Product Name is <%= request.getAttribute("InsProductName") %>
<br>
The Insurance Product Status is <%= request.getAttribute("InsProductStatus") %>
<br>
Please, Note the Product ID for Future Reference.
